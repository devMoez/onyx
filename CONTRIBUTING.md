...
- **[Before you begin](#before-you-begin):** Essential steps to take before
  becoming a Onyx CLI contributor.
...
- **[Documentation contribution process](#documentation-contribution-process):**
  How to contribute documentation to Onyx CLI.
...
To start the Onyx CLI from the source code (after building), run the following
...
the Onyx CLI. They are not run as part of the default `npm run test` command.
...
1.  **Start the Onyx CLI in development mode:**
...
as you start/stop Onyx CLI. Files created within the sandbox should be
...
We appreciate your contributions to making Onyx CLI documentation better!
