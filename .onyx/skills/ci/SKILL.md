...
name: ci
description:
  A specialized skill for Onyx CLI that provides high-performance, fail-fast
...
- **Tool**: `node .onyx/skills/ci/scripts/ci.mjs [branch]`
...
- **Tool**: `node .onyx/skills/ci/scripts/ci.mjs [branch] [run_id]`
- **Discovery**: The script **automatically** finds the latest active or recent
