...
Tailwind uses mobile-first responsive design. Base styles apply to all screen
sizes, then use breakpoint prefixes to override at larger sizes.
...
Test at exact breakpoint widths (640px, 768px, 1024px, etc.) to catch edge
cases.
