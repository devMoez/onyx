...
## 🚨 CRITICAL: macOS Daemon Workaround & Onyx CLI Usage 🚨
...
### Testing the Onyx CLI

When testing the Onyx CLI with `agent-tui`, there are several strict requirements to ensure deterministic and accurate behavior:
