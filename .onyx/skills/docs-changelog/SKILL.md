...
- Refer to `.onyx/skills/docs-changelog/references/highlights_examples.md`
...
1.  **Create the Announcement for `index.md`**:
    ...
    -   **Important**: The format for this announcement is unique. You **must**
        ...
        example within
        `.onyx/skills/docs-changelog/references/index_template.md` as your
...
2.  **Create Highlights and Update `latest.md`**:
    ...
    -   Take the content from
        `.onyx/skills/docs-changelog/references/latest_template.md`.
...
1.  **Update `preview.md`**:
    -   Generate a comprehensive "Highlights" section, following the highlight
        guidelines.
    -   Take the content from
        `.onyx/skills/docs-changelog/references/preview_template.md`.
    -   Populate the template with the `version`, `release_date`, generated
        `highlights`, and the processed content from the temporary file.
...
- Perform the following edits on the target file:
    ...
    5.  In the "Full Changelog", edit **only** the end of the URL. Identify the
        ...
        `Full Changelog: https://github.com/google-onyx/onyx-cli/compare/v0.28.2…v0.29.0`
        to
        `Full Changelog: https://github.com/google-onyx/onyx-cli/compare/v0.28.2…v0.29.1`
...
- Perform the following edits on the target file:
    ...
    5.  In the "Full Changelog", edit **only** the end of the URL. Identify the
        ...
        `Full Changelog: https://github.com/google-onyx/onyx-cli/compare/v0.28.2…v0.29.0-preview.0`
        to
        `Full Changelog: https://github.com/google-onyx/onyx-cli/compare/v0.28.2…v0.29.0-preview.1`
