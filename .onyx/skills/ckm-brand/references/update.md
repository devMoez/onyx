Update brand colors, typography, and style - automatically syncs to all design
system files.
...
- Mood keywords (e.g., "professional, trustworthy, premium" or "bold, creative,
  energetic")
...
3. **Color Palette section** - Update Primary, Secondary, Accent colors with
   shades
4. **AI Image Generation section** - Update base prompt, keywords, mood
   descriptors
...
- **Test image generation** - Optionally generate a test image to verify brand
  application
