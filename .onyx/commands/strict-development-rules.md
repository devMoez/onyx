# Onyx CLI Strict Development Rules
...
- **Keyboard Handling**: Keyboard handling MUST go through `useKeyPress.ts` from
  the Onyx CLI package rather than the standard ink library. This library
...
## General Onyx CLI Design Principles
...
- **Prompts**: Be aware that changes can impact the prompts sent to Onyx CLI and
