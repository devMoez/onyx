...
Onyx CLI supports several built-in commands to help you manage your session,
...
- **Description:** File an issue about Onyx CLI. By default, the issue is
...
- **Sub-commands:**
  ...
  - **`resume <tag>`**
    ...
    - **Note:** You can only resume chats that were saved within the current
      ...
      Onyx CLI from that project's directory.
...
- **Description:** Copies the last output produced by Onyx CLI to your
...
- **Description:** Open Onyx CLI documentation in your browser.
...
- **Description:** Manage extensions. See
  [Onyx CLI Extensions](../extensions/index.md).
- **Sub-commands:**
  - **`config`**:
...
- **Description:** Display help information about Onyx CLI, including
  available commands and their usage.

### `/hooks`

- **Description:** Manage hooks, which allow you to intercept and customize
  Onyx CLI behavior at specific lifecycle events.
- **Sub-commands:**
  - **`disable-all`**:
...
- **Description:** Open the settings editor to view and modify Onyx CLI
  settings.
...
- **Description:** Display detailed statistics for the current Onyx CLI
  session.
- **Sub-commands:**
  - **`session`**:
...
- **`!<shell_command>`**
  - **Description:** Execute the given `<shell_command>` using `bash` on
    ...
    the terminal.
  - **Examples:**
    - `!ls -la` (executes `ls -la` and returns to Onyx CLI)
    - `!git status` (executes `git status` and returns to Onyx CLI)
