...
The `activate_skill` tool lets Onyx CLI load specialized procedural expertise
...
tasks, such as reviewing code or creating pull requests. Onyx CLI uses this
...
The `activate_skill` tool is used exclusively by the Onyx agent. You cannot
