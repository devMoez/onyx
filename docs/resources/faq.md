...
problems encountered while using Onyx CLI.

## General issues

This section addresses common questions about Onyx CLI usage, security, and
...
### How do I check which version of Onyx CLI I'm currently running?
...
### Where are Onyx CLI configuration and settings files stored?
