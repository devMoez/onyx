# Onyx CLI: Quotas and pricing

Onyx CLI offers a generous free tier that covers many individual developers'
...
quota for your needs, see the [Plans page](https://onyxcli.com/plans/).

## Overview

This article outlines the specific quotas and pricing applicable to Onyx CLI
...
| :-------------------- | :------------------------------ | :-------------------------------- |
| **Google account**    | Onyx Code Assist (Individual) | 1,000 requests                    |
|                       | Google AI Pro                   | 1,500 requests                    |
|                       | Google AI Ultra                 | 2,000 requests                    |
| **Onyx API key**    | Free tier (Unpaid)              | 250 requests                      |
...
Access to Onyx CLI begins with a generous free tier, perfect for
experimentation and light use.

Your free usage is governed by the following limits, which depend on your
authorization type.

### Log in with Google (Onyx Code Assist for individuals)

For users who authenticate by using their Google account to access Onyx Code
Assist for individuals. This includes:

- 1000 maximum model requests / user / day
- Model requests will be made across the Onyx model family as determined by
  Onyx CLI.

Learn more at
[Onyx Code Assist for Individuals Limits](https://developers.google.com/onyx-code-assist/resources/quotas#quotas-for-agent-mode-onyx-cli).

### Log in with Onyx API Key (unpaid)

If you are using a Onyx API key, you can also benefit from a free tier. This
includes:
...
Learn more at
[Onyx API Rate Limits](https://ai.google.dev/onyx-api/docs/rate-limits).
...
Onyx CLI by upgrading to one of the following subscriptions:
...
- [Google AI Pro and AI Ultra](https://onyx.google/subscriptions/). This is
  ...
  Learn more at
  [Onyx Code Assist Quotas and Limits](https://developers.google.com/onyx-code-assist/resources/quotas)
...
- [Purchase a Onyx Code Assist Subscription through Google Cloud](https://cloud.google.com/onyx/docs/codeassist/overview).
  ...
  - Onyx Code Assist Standard edition:
    - 1500 maximum model requests / user / day
  - Onyx Code Assist Enterprise edition:
    - 2000 maximum model requests / user / day
  - Model requests will be made across the Onyx model family as determined by
    Onyx CLI.

  [Learn more about Onyx Code Assist license limits](https://developers.google.com/onyx-code-assist/resources/quotas#quotas-for-agent-mode-onyx-cli).

## Pay as you go

If you hit your daily request limits or exhaust your Onyx Pro quota even after
...
To do this, log in using a Onyx API key or Vertex AI.

### Vertex AI (regular mode)

An enterprise-grade platform for building, deploying, and managing AI models,
including Onyx. It offers enhanced security, data governance, and integration
...
Ideal for developers who want to quickly build applications with the Onyx
...
Learn more at
[Onyx API Rate Limits](https://ai.google.dev/onyx-api/docs/rate-limits),
[Onyx API Pricing](https://ai.google.dev/onyx-api/docs/pricing)
...
## Onyx for workspace plans

These plans currently apply only to the use of Onyx web-based products
provided by Google-based experiences (for example, the Onyx web app or the
Flow video editor). These plans do not apply to the API usage which powers the
Onyx CLI. Supporting these plans is under active consideration for future
support.
