# Onyx CLI release notes

Onyx CLI has three major release channels: nightly, preview, and stable. For
...
[Releases - google-onyx/onyx-cli](https://github.com/google-onyx/onyx-cli/releases)
on GitHub.
...
- **Auto Memory Inbox:** Introduced a new inbox flow for Auto Memory with a
  ...
  ([#26338](https://github.com/google-onyx/onyx-cli/pull/26338) by
  @SandyTao520).
- **Gemma 4 by Default:** Enabled Gemma 4 models by default via the Onyx API
  for all users
  ([#26307](https://github.com/google-onyx/onyx-cli/pull/26307) by
  @Abhijit-2592).
- **Voice Mode Enhancements:** Added wave animations and privacy/compliance UX
  warnings for the Onyx Live backend
  ([#26284](https://github.com/google-onyx/onyx-cli/pull/26284) by
  @devr0306, [#26454](https://github.com/google-onyx/onyx-cli/pull/26454) by
  @cocosheng-g).
...
- **Offline Search and Themes:** Bundled ripgrep for offline search support and
  ...
  ([#25342](https://github.com/google-onyx/onyx-cli/pull/25342) by
  @scidomino, [#15504](https://github.com/google-onyx/onyx-cli/pull/15504)
  by @Z1xus).
- **Advanced Resource and Memory Management:** Introduced MCP resource tools and
  ...
  ([#25395](https://github.com/google-onyx/onyx-cli/pull/25395) by
  @ruomengz, [#25716](https://github.com/google-onyx/onyx-cli/pull/25716) by
  @SandyTao520).
- **UX and Local Models:** Enabled topic update narrations by default and
  streamlined Gemma local model setup with `onyx gemma`
  ([#25586](https://github.com/google-onyx/onyx-cli/pull/25586) by
  @gundermanc, [#25498](https://github.com/google-onyx/onyx-cli/pull/25498)
  by @Samee24).
...
- **Skill Management:** Added a new `/memory` inbox command for reviewing and
  ...
  ([#24544](https://github.com/google-onyx/onyx-cli/pull/24544) by
  @SandyTao520, [#25148](https://github.com/google-onyx/onyx-cli/pull/25148)
  by @SandyTao520).
- **Improved Transparency:** Plan Mode now requires confirmation for skill
  activation and allows plan inspection
  ([#24946](https://github.com/google-onyx/onyx-cli/pull/24946),
  [#25058](https://github.com/google-onyx/onyx-cli/pull/25058) by
  @ruomengz).
- **Architecture & Reliability:** Introduced a decoupled `ContextManager`
  ...
  issues ([#24752](https://github.com/google-onyx/onyx-cli/pull/24752) by
  @joshualitt, [#25079](https://github.com/google-onyx/onyx-cli/pull/25079)
  by @spencer426).
...
- **Chapters Narrative Flow:** Group agent interactions into "Chapters" based on
  ...
  ([#23150](https://github.com/google-onyx/onyx-cli/pull/23150) by
  @Abhijit-2592,
  [#24079](https://github.com/google-onyx/onyx-cli/pull/24079) by
  @gundermanc).
- **Context Compression Service:** Advanced context management to efficiently
  distill conversation history
  ([#24483](https://github.com/google-onyx/onyx-cli/pull/24483) by
  @joshualitt).
- **UI Flicker & UX Enhancements:** Solved rendering flicker with "Terminal
  Buffer" mode and introduced selective topic expansion
  ([#24512](https://github.com/google-onyx/onyx-cli/pull/24512) by
  @jacob314, [#24793](https://github.com/google-onyx/onyx-cli/pull/24793) by
  @Abhijit-2592).
- **Persistent Policy Approvals:** Implemented context-aware persistent
  approvals for tool execution
  ([#23257](https://github.com/google-onyx/onyx-cli/pull/23257) by @jerop).
...
- **Dynamic Sandbox Expansion:** Implemented dynamic sandbox expansion and
  ...
  ([#23692](https://github.com/google-onyx/onyx-cli/pull/23692) by @galz10,
  [#23691](https://github.com/google-onyx/onyx-cli/pull/23691) by
  @scidomino).
...
- **Advanced Browser Capabilities:** Enhanced the browser agent with persistent
  ...
  ([#21306](https://github.com/google-onyx/onyx-cli/pull/21306) by
  @kunal-10-cloud,
  [#23805](https://github.com/google-onyx/onyx-cli/pull/23805) by
  @cynthialong0-0).
...
- **Multi-Registry Architecture and Sandboxing:** Introduced a multi-registry
  ...
  ([#22712](https://github.com/google-onyx/onyx-cli/pull/22712),
  [#22718](https://github.com/google-onyx/onyx-cli/pull/22718) by @akh64bit,
  [#22832](https://github.com/google-onyx/onyx-cli/pull/22832) by @ehedlund,
  [#21807](https://github.com/google-onyx/onyx-cli/pull/21807) by
  @mattKorwel).
- **Refreshed Composer UX:** Implemented a refreshed user experience for the
  ...
  ([#21212](https://github.com/google-onyx/onyx-cli/pull/21212),
  [#23286](https://github.com/google-onyx/onyx-cli/pull/23286) by
  @jwhelangoog).
- **Git Worktree Support:** Added native support for Git worktrees, allowing for
  isolated parallel sessions
  ([#22973](https://github.com/google-onyx/onyx-cli/pull/22973),
  [#23265](https://github.com/google-onyx/onyx-cli/pull/23265) by @jerop).
- **Subagent Context and Feedback:** Enhanced subagents with JIT context
  ...
  ([#23032](https://github.com/google-onyx/onyx-cli/pull/23032),
  [#22951](https://github.com/google-onyx/onyx-cli/pull/22951) by
  @abhipatel12).
...
- **Customizable Keyboard Shortcuts:** Users can now customize their keyboard
  ...
  ([#21945](https://github.com/google-onyx/onyx-cli/pull/21945),
  [#21972](https://github.com/google-onyx/onyx-cli/pull/21972) by
  @scidomino).
- **Vim Mode Improvements:** Added missing motions (X, ~, r, f/F/t/T) and
  yank/paste support with the unnamed register
  ([#21932](https://github.com/google-onyx/onyx-cli/pull/21932),
  [#22026](https://github.com/google-onyx/onyx-cli/pull/22026) by @aanari).
- **Tool Isolation and Sandboxing:** Introduced `SandboxManager` to isolate
  ...
  ([#21774](https://github.com/google-onyx/onyx-cli/pull/21774),
  [#22231](https://github.com/google-onyx/onyx-cli/pull/22231) by @galz10,
  [#22680](https://github.com/google-onyx/onyx-cli/pull/22680) by
  @DavidAPierce).
- **JIT Context Discovery:** Implemented Just-In-Time context discovery for file
  ...
  ([#22082](https://github.com/google-onyx/onyx-cli/pull/22082),
  [#22736](https://github.com/google-onyx/onyx-cli/pull/22736) by
  @SandyTao520).
...
- **Plan Mode Enabled by Default:** Plan Mode is now enabled by default to help
  ...
  ([#21713](https://github.com/google-onyx/onyx-cli/pull/21713) by @jerop).
- **Sandboxing Enhancements:** We've added native gVisor (runsc) and
  ...
  ([#21062](https://github.com/google-onyx/onyx-cli/pull/21062) by
  @Zheyuan-Lin, [#20735](https://github.com/google-onyx/onyx-cli/pull/20735)
  by @h30s).
...
- **Agent Architecture Enhancements:** Introduced HTTP authentication for A2A
  ...
  ([#20510](https://github.com/google-onyx/onyx-cli/pull/20510) by
  @SandyTao520, [#20622](https://github.com/google-onyx/onyx-cli/pull/20622)
  by @SandyTao520).
- **Plan Mode Updates:** Expanded Plan Mode with built-in research subagents,
  ...
  ([#20972](https://github.com/google-onyx/onyx-cli/pull/20972) by @Adib234,
  [#20988](https://github.com/google-onyx/onyx-cli/pull/20988) by
  @ruomengz).
- **CLI UX & Admin Controls:** Redesigned the header to be compact with an ASCII
  ...
  ([#18713](https://github.com/google-onyx/onyx-cli/pull/18713) by
  @keithguerin, [#20853](https://github.com/google-onyx/onyx-cli/pull/20853)
  by @skeshive).
...
- **Generalist Agent:** The generalist agent is now enabled to improve task
  ...
  ([#19665](https://github.com/google-onyx/onyx-cli/pull/19665) by
  @joshualitt).
- **Model Steering in Workspace:** Added support for model steering directly in
  the workspace
  ([#20343](https://github.com/google-onyx/onyx-cli/pull/20343) by
  @joshualitt).
- **Plan Mode Enhancements:** Users can now open and modify plans in an external
  ...
  ([#20348](https://github.com/google-onyx/onyx-cli/pull/20348) by @Adib234,
  [#20465](https://github.com/google-onyx/onyx-cli/pull/20465) by @jerop).
- **Interactive Shell Autocompletion:** Introduced interactive shell
  autocompletion for a more seamless experience
  ([#20082](https://github.com/google-onyx/onyx-cli/pull/20082) by
  @mrpmohiburrahman).
- **Parallel Extension Loading:** Extensions are now loaded in parallel to
  improve startup times
  ([#20229](https://github.com/google-onyx/onyx-cli/pull/20229) by
  @scidomino).

## Announcements: v0.31.0 - 2026-02-27

- **Onyx 3.1 Pro Preview:** Onyx CLI now supports the new Onyx 3.1 Pro
  Preview model
  ([#19676](https://github.com/google-onyx/onyx-cli/pull/19676) by
  @sehoon38).
- **Experimental Browser Agent:** We've introduced a new experimental browser
  agent to interact with web pages
  ([#19284](https://github.com/google-onyx/onyx-cli/pull/19284) by
  @gsquared94).
- **Policy Engine Updates:** The policy engine now supports project-level
  ...
  ([#18682](https://github.com/google-onyx/onyx-cli/pull/18682) by
  @Abhijit-2592,
  [#20024](https://github.com/google-onyx/onyx-cli/pull/20024) by @jerop).
- **Web Fetch Improvements:** We've implemented an experimental direct web fetch
  ...
  ([#19557](https://github.com/google-onyx/onyx-cli/pull/19557) by @mbleigh,
  [#19567](https://github.com/google-onyx/onyx-cli/pull/19567) by
  @mattKorwel).
...
- **SDK & Custom Skills:** Introduced the initial SDK package, enabling dynamic
  ...
  custom skills
  ([#18861](https://github.com/google-onyx/onyx-cli/pull/18861) by
  @mbleigh).
- **Policy Engine Enhancements:** Added a new `--policy` flag for user-defined
  ...
  ([#18500](https://github.com/google-onyx/onyx-cli/pull/18500) by
  @allenhutchison).
- **UI & Themes:** Added a generic searchable list for settings and extensions,
  ...
  prototype ([#19064](https://github.com/google-onyx/onyx-cli/pull/19064) by
  @rmedranollamas).
- **Vim & Terminal Interaction:** Improved Vim support to feel more complete and
  added support for Ctrl-Z terminal suspension
  ([#18755](https://github.com/google-onyx/onyx-cli/pull/18755) by
  @ppgranger, [#18931](https://github.com/google-onyx/onyx-cli/pull/18931)
  by @scidomino).
...
- **Plan Mode:** A new comprehensive planning capability with `/plan`,
  ...
  ([#17698](https://github.com/google-onyx/onyx-cli/pull/17698) by @Adib234,
  [#18324](https://github.com/google-onyx/onyx-cli/pull/18324) by @jerop).
- **Onyx 3 Default:** We've removed the preview flag and enabled Onyx 3 by
  default for all users
  ([#18414](https://github.com/google-onyx/onyx-cli/pull/18414) by
  @sehoon38).
- **Extension Exploration:** New UI and settings to explore and manage
  extensions more easily
  ([#18686](https://github.com/google-onyx/onyx-cli/pull/18686) by
  @sripasg).
- **Admin Control:** Administrators can now allowlist specific MCP server
  configurations
  ([#18311](https://github.com/google-onyx/onyx-cli/pull/18311) by
  @skeshive).

## Announcements: v0.28.0 - 2026-02-10

- **IDE Support:** Onyx CLI now supports the Positron IDE
  ([#15047](https://github.com/google-onyx/onyx-cli/pull/15047) by
  @kapsner).
- **Customization:** You can now use custom themes in extensions, and we've
  ...
  ([#17327](https://github.com/google-onyx/onyx-cli/pull/17327) by
  @spencer426, [#17976](https://github.com/google-onyx/onyx-cli/pull/17976)
  by @Abhijit-2592).
- **Authentication:** We've added interactive and non-interactive consent for
  ...
  ([#17699](https://github.com/google-onyx/onyx-cli/pull/17699) by
  @ehedlund, [#17569](https://github.com/google-onyx/onyx-cli/pull/17569) by
  @erikus).
...
- **Event-Driven Architecture:** The CLI now uses a new event-driven scheduler
  ...
  ([#17078](https://github.com/google-onyx/onyx-cli/pull/17078) by
  @abhipatel12).
...
- **Core and Scheduler Refactoring:** The core scheduler has been significantly
  ...
  ([#16895](https://github.com/google-onyx/onyx-cli/pull/16895) by
...
- **Agent Skills:** We've introduced significant advancements in Agent Skills.
  ...
  and powerful automation within Onyx CLI.
  ([#15869](https://github.com/google-onyx/onyx-cli/pull/15869) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#16013](https://github.com/google-onyx/onyx-cli/pull/16013) by
...
- **Improved UI/UX:** The user interface has received several updates, featuring
  ...
  and input areas.
  ([#15408](https://github.com/google-onyx/onyx-cli/pull/15408) by
...
- **Enhanced Security:** Security has been a major focus, with default folder
  ...
  ([#15943](https://github.com/google-onyx/onyx-cli/pull/15943) by
  [@galz10](https://github.com/galz10)),
  ([#15977](https://github.com/google-onyx/onyx-cli/pull/15977) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))
- **Core Functionality:** This release includes a mandatory MessageBus
  ...
  ([#15776](https://github.com/google-onyx/onyx-cli/pull/15776) by
  [@abhipatel12](https://github.com/abhipatel12)),
  ([#16300](https://github.com/google-onyx/onyx-cli/pull/16300) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))
- **Terminal Features:** Terminal interactions are more seamless with new
  ...
  ([#15336](https://github.com/google-onyx/onyx-cli/pull/15336) by
  [@scidomino](https://github.com/scidomino)),
  ([#15932](https://github.com/google-onyx/onyx-cli/pull/15932) by
  [@scidomino](https://github.com/scidomino))
- **New Commands:** To manage the new features, we've added several new
  ...
  ([#16204](https://github.com/google-onyx/onyx-cli/pull/16204) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#15865](https://github.com/google-onyx/onyx-cli/pull/15865) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#16377](https://github.com/google-onyx/onyx-cli/pull/16377) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))

## Announcements: v0.23.0 - 2026-01-07

- 🎉 **Experimental Agent Skills Support in Preview:** Onyx CLI now supports
  [Agent Skills](https://agentskills.io/home) in our preview builds. This is an
  early preview where we’re looking for feedback!
  - Install Preview: `npm install -g @google/onyx-cli@preview`
  - Enable in `/settings`
  - Docs:
    [https://onyxcli.com/docs/cli/skills/](https://onyxcli.com/docs/cli/skills/)
- **Onyx CLI wrapped:** Run `npx onyx-wrapped` to visualize your usage stats,
  top models, languages, and more!
- **Windows clipboard image support:** Windows users can now paste images
  directly from their clipboard into the CLI using `Alt`+`V`.
  ([pr](https://github.com/google-onyx/onyx-cli/pull/13997) by
...
- **Terminal background color detection:** Automatically optimizes your
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/15132) by
...
- **Session logout:** Use the new `/logout` command to instantly clear
  ...
  switching. ([pr](https://github.com/google-onyx/onyx-cli/pull/13383) by
  [@CN-Scars](https://github.com/CN-Scars))

## Announcements: v0.22.0 - 2025-12-22

- 🎉**Free Tier + Onyx 3:** Free tier users now all have access to Onyx 3
  Pro & Flash. Enable in `/settings` by toggling "Preview Features" to `true`.
- 🎉**Onyx CLI + Colab:** Onyx CLI is now pre-installed. Can be used headlessly
  in notebook cells or interactively in the built-in terminal
  ([pic](https://imgur.com/a/G0Tn7vi))
- 🎉**Onyx CLI Extensions:**
  - **Conductor:** Planning++, Onyx works with you to build out a detailed
    plan, pull in extra details as needed, ultimately to give the LLM guardrails
    with artifacts. Measure twice, implement once!

    `onyx extensions install https://github.com/onyx-cli-extensions/conductor`

    Blog:
    [https://developers.googleblog.com/conductor-introducing-context-driven-development-for-onyx-cli/](https://developers.googleblog.com/conductor-introducing-context-driven-development-for-onyx-cli/)

  - **Endor Labs:** Perform code analysis, vulnerability scanning, and
    dependency checks using natural language.

    `onyx extensions install https://github.com/endorlabs/onyx-extension`

## Announcements: v0.21.0 - 2025-12-15

- **⚡️⚡️⚡️ Onyx 3 Flash + Onyx CLI:** Better, faster and cheaper than 2.5
...
- For more information:
  [Onyx 3 Flash is now available in Onyx CLI](https://developers.googleblog.com/onyx-3-flash-is-now-available-in-onyx-cli/).
- 🎉 Onyx CLI Extensions:
  - Rill: Utilize natural language to analyze Rill data, enabling the
    ...
    `onyx extensions install https://github.com/rilldata/rill-onyx-extension`
  - Browserbase: Interact with web pages, take screenshots, extract information,
    ...
    `onyx extensions install https://github.com/browserbase/mcp-server-browserbase`
...
- **Multi-file Drag & Drop:** Users can now drag and drop multiple files into
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/14832) by
...
- **Persistent "Always Allow" Policies:** Users can now save "Always Allow"
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/14737) by
...
- 🎉 **New extensions:**
  - **Eleven Labs:** Create, play, manage your audio play tracks with the Eleven
    Labs Onyx CLI extension:
    `onyx extensions install https://github.com/elevenlabs/elevenlabs-mcp`
- **Zed integration:** Users can now leverage Onyx 3 within the Zed
  integration after enabling "Preview Features" in their CLI’s `/settings`.
  ([pr](https://github.com/google-onyx/onyx-cli/pull/13398) by
...
- **Interactive shell:**
  - **Click-to-Focus:** When "Use Alternate Buffer" setting is enabled, users
    ...
    ([pr](https://github.com/google-onyx/onyx-cli/pull/13341) by
    [@galz10](https://github.com/galz10))
  - **Loading phrase:** Clearly indicates when the interactive shell is awaiting
    user input. ([vid](https://imgur.com/a/kjK8bUK),
    [pr](https://github.com/google-onyx/onyx-cli/pull/12535) by
    [@jackwotherspoon](https://github.com/jackwotherspoon))

## Announcements: v0.18.0 - 2025-11-17

- 🎉 **New extensions:**
  - **Google Workspace**: Integrate Onyx CLI with your Workspace data. Write
  ...
  - **Redis:** Manage and search data in Redis with natural language:
    `onyx extensions install https://github.com/redis/mcp-redis`
  - **Anomalo:** Query your data warehouse table metadata and quality status
    through commands and natural language:
    `onyx extensions install https://github.com/datagravity-ai/anomalo-onyx-extension`
- **Experimental permission improvements:** We are now experimenting with a new
  policy engine in Onyx CLI. This allows users and administrators to create
...
- **Onyx 3 support for paid:** Onyx 3 support has been rolled out to all API
  key, Google AI Pro or Google AI Ultra (for individuals, not businesses) and
  Onyx Code Assist Enterprise users. Enable it via `/settings` and toggling on
  **Preview Features**.
...
- **Model in history:** Users can now toggle in `/settings` to display model in
  ...
  [pr](https://github.com/google-onyx/onyx-cli/pull/13034) by
  [@scidomino](https://github.com/scidomino))
- **Multi-uninstall:** Users can now uninstall multiple extensions with a single
  command. ([pic](https://imgur.com/a/9Dtq8u2),
  [pr](https://github.com/google-onyx/onyx-cli/pull/13016) by
  [@JayadityaGit](https://github.com/JayadityaGit))

## Announcements: v0.16.0 - 2025-11-10

- **Onyx 3 + Onyx CLI:** launch 🚀🚀🚀
- **Data Commons Onyx CLI Extension** - A new Data Commons Onyx CLI extension
  ...
  [https://github.com/onyx-cli-extensions/datacommons](https://github.com/onyx-cli-extensions/datacommons).

## Announcements: v0.15.0 - 2025-11-03

- **🎉 Seamless scrollable UI and mouse support:** We’ve given Onyx CLI a major
...
- **🎉 New partner extensions:**
  - **Arize:** Seamlessly instrument AI applications with Arize AX and grant
    ...
    `onyx extensions install https://github.com/Arize-ai/arize-tracing-assistant`

  - **Chronosphere:** Retrieve logs, metrics, traces, events, and specific
    entities:

    `onyx extensions install https://github.com/chronosphereio/chronosphere-mcp`
  ...
  - **Transmit:** Comprehensive context, validation, and automated fixes for
    ...
    `onyx extensions install https://github.com/TransmitSecurity/transmit-security-journey-builder`
...
- **Todo planning:** Complex questions now get broken down into todo lists that
  ...
  [pr](https://github.com/google-onyx/onyx-cli/pull/12905) by
...
- **Disable GitHub extensions:** Users can now prevent the installation and
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/12838) by
...
- **🎉 New partner extensions:**
  - **🤗 Hugging Face extension:** Access the Hugging Face hub.
    ...
    `onyx extensions install https://github.com/huggingface/hf-mcp-server`
  ...
  - **Monday.com extension**: Analyze your sprints, update your task boards,
    ...
    `onyx extensions install https://github.com/mondaycom/mcp`
  ...
  - **Data Commons extension:** Query public datasets or ground responses on
    ...
    `onyx extensions install https://github.com/onyx-cli-extensions/datacommons`

- **Model selection:** Choose the Onyx model for your session with `/model`.
  ([pic](https://imgur.com/a/ABFcWWw),
  [pr](https://github.com/google-onyx/onyx-cli/pull/8940) by
  [@abhipatel12](https://github.com/abhipatel12)).
- **Model routing:** Onyx CLI will now intelligently pick the best model for the
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/9262) by
  [@abhipatel12](https://github.com/abhipatel12)).
  - Discussion:
    [https://github.com/google-onyx/onyx-cli/discussions/12375](https://github.com/google-onyx/onyx-cli/discussions/12375)
- **Codebase investigator subagent:** We now have a new built-in subagent that
  ...
  overall performance.
  ([pr](https://github.com/google-onyx/onyx-cli/pull/9988) by
  [@abhipatel12](https://github.com/abhipatel12),
  [pr](https://github.com/google-onyx/onyx-cli/pull/10282) by
  ...
  - Enable, disable, or limit turns in `/settings`, plus advanced configs in
    ...
    [pr](https://github.com/google-onyx/onyx-cli/pull/10844) by
    [@silviojr](https://github.com/silviojr)).
- **Explore extensions with `/extension`:** Users can now open the extensions
  ...
  explore command. ([pr](https://github.com/google-onyx/onyx-cli/pull/11846)
...
- **Configurable compression:** Users can modify the context compression
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/12317) by
  [@scidomino](https://github.com/scidomino)).
- **API key authentication:** Users can now securely enter and store their
  Onyx API key via a new dialog, eliminating the need for environment
  variables and repeated entry.
  ([pr](https://github.com/google-onyx/onyx-cli/pull/11760) by
  [@galz10](https://github.com/galz10)).
- **Sequential approval:** Users can now approve multiple tool calls
  sequentially during execution.
  ([pr](https://github.com/google-onyx/onyx-cli/pull/11593) by
  [@joshualitt](https://github.com/joshualitt)).

## Announcements: v0.11.0 - 2025-10-20

![Onyx CLI and Jules](https://storage.googleapis.com/gweb-developer-goog-blog-assets/images/Jules_Extension_-_Blog_Header_O346JNt.original.png)

- 🎉 **Onyx CLI Jules Extension:** Use Onyx CLI to orchestrate Jules. Spawn
  remote workers, delegate tedious tasks, or check in on running jobs!
  - Install:
    `onyx extensions install https://github.com/onyx-cli-extensions/jules`
  - Announcement:
    [https://developers.googleblog.com/en/introducing-the-jules-extension-for-onyx-cli/](https://developers.googleblog.com/en/introducing-the-jules-extension-for-onyx-cli/)
- **Stream JSON output:** Stream real-time JSONL events with
  ...
  [pr](https://github.com/google-onyx/onyx-cli/pull/10883) by
  [@anj-s](https://github.com/anj-s))
- **Markdown toggle:** Users can now switch between rendered and raw markdown
  ...
  [pr](https://github.com/google-onyx/onyx-cli/pull/10383) by
...
- **Queued message editing:** Users can now quickly edit queued messages by
  ...
  [pr](https://github.com/google-onyx/onyx-cli/pull/10392) by
...
- **JSON web fetch**: Non-HTML content like JSON APIs or raw source code are now
  ...
  [pr](https://github.com/google-onyx/onyx-cli/pull/11284) by
  [@abhipatel12](https://github.com/abhipatel12))
- **Non-interactive MCP commands:** Users can now run MCP slash commands in
  non-interactive mode `onyx "/some-mcp-prompt"`.
  ([pr](https://github.com/google-onyx/onyx-cli/pull/10194) by
  [@capachino](https://github.com/capachino))
- **Removal of deprecated flags:** We’ve finally removed a number of deprecated
  flags to cleanup Onyx CLI’s invocation profile:
  - `--all-files` / `-a` in favor of `@` from within Onyx CLI.
    ([pr](https://github.com/google-onyx/onyx-cli/pull/11228) by
    [@allenhutchison](https://github.com/allenhutchison))
  - `--telemetry-*` flags in favor of
    [environment variables](https://github.com/google-onyx/onyx-cli/pull/11318)
    ([pr](https://github.com/google-onyx/onyx-cli/pull/11318) by
    [@allenhutchison](https://github.com/allenhutchison))
...
- **Interactive Shell Tool calling:** Onyx CLI can now also execute interactive
  tools if needed ([pr](https://github.com/google-onyx/onyx-cli/pull/11225)
...
- **Alt+Key support:** Enables broader support for Alt+Key keyboard shortcuts
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/10767) by
  [@srivatsj](https://github.com/srivatsj)).
- **Telemetry Diff stats:** Track line changes made by the model and user during
  file operations via OTEL.
  ([pr](https://github.com/google-onyx/onyx-cli/pull/10819) by
...
- 🎉 **Interactive Shell:** Run interactive commands like `vim`, `rebase -i`, or
  even `onyx` 😎 directly in Onyx CLI:
  - Blog:
    [https://developers.googleblog.com/en/say-hello-to-a-new-level-of-interactivity-in-onyx-cli/](https://developers.googleblog.com/en/say-hello-to-a-new-level-of-interactivity-in-onyx-cli/)
- **Install pre-release extensions:** Install the latest `--pre-release`
  ...
  marked as "latest".
  ([pr](https://github.com/google-onyx/onyx-cli/pull/10752) by
  [@jakemac53](https://github.com/jakemac53))
- **Simplified extension creation:** Create a new, empty extension. Templates
  are no longer required.
  ([pr](https://github.com/google-onyx/onyx-cli/pull/10629) by
...
- **OpenTelemetry GenAI metrics:** Aligns telemetry with industry-standard
  ...
  [pr](https://github.com/google-onyx/onyx-cli/pull/10343) by
  [@jerop](https://github.com/jerop))
- **List memory files:** Quickly find the location of your long-term memory
  files with `/memory list`.
  ([pr](https://github.com/google-onyx/onyx-cli/pull/10108) by
  [@sgnagnarella](https://github.com/sgnagnarella))

## Announcements: v0.8.0 - 2025-09-29

- 🎉 **Announcing Onyx CLI Extensions** 🎉
  - Completely customize your Onyx CLI experience to fit your workflow.
  - Build and share your own Onyx CLI extensions with the world.
  - Launching with a growing catalog of community, partner, and Google-built
    extensions.
    - Check extensions from
      [key launch partners](https://github.com/google-onyx/onyx-cli/discussions/10718).
  - Easy install:
    - `onyx extensions install <github url|folder path>`
  - Easy management:
    - `onyx extensions install|uninstall|link`
    - `onyx extensions enable|disable`
    - `onyx extensions list|update|new`
  - Or use commands while running with `/extensions list|update`.
  - Everything you need to know:
    [Now open for building: Introducing Onyx CLI extensions](https://blog.google/technology/developers/onyx-cli-extensions/).
- 🎉 **Our New Home Page & Better Documentation** 🎉
  ...
  - _Homepage:_ [https://onyxcli.com](https://onyxcli.com)
  - ‼️*NEW documentation:*
    [https://onyxcli.com/docs](https://onyxcli.com/docs) (Have any
    [suggestions](https://github.com/google-onyx/onyx-cli/discussions/8722)?)
  - _Extensions:_
    [https://onyxcli.com/extensions](https://onyxcli.com/extensions)
- **Non-Interactive Allowed Tools:** `--allowed-tools` will now also work in
  non-interactive mode.
  ([pr](https://github.com/google-onyx/onyx-cli/pull/9114) by
...
- **Terminal Title Status:** See the CLI's real-time status and thoughts
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/4386) by
...
- 🎉**Build your own Onyx CLI IDE plugin:** We've published a spec for creating
  IDE plugins to enable rich context-aware experiences and native in-editor
  diffing in your IDE of choice.
  ([pr](https://github.com/google-onyx/onyx-cli/pull/8479) by
  [@skeshive](https://github.com/skeshive))
- 🎉 **Onyx CLI extensions**
  - **Flutter:** An early version to help you create, build, test, and run
    Flutter apps with Onyx CLI
    ([extension](https://github.com/onyx-cli-extensions/flutter))
  - **nanobanana:** Integrate nanobanana into Onyx CLI
    ([extension](https://github.com/onyx-cli-extensions/nanobanana))
- **Telemetry config via environment:** Manage telemetry settings using
  environment variables for a more flexible setup.
  ([docs](https://github.com/google-onyx/onyx-cli/blob/main/docs/cli/telemetry.md#configuration),
  [pr](https://github.com/google-onyx/onyx-cli/pull/9113) by
  [@jerop](https://github.com/jerop))
- **​​Experimental todos:** Track and display progress on complex tasks with a
  ...
  `"useWriteTodos": true`
  ([pr](https://github.com/google-onyx/onyx-cli/pull/8761) by
  [@anj-s](https://github.com/anj-s))
- **Share chat support for tools:** Using `/chat share` will now also render
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/8693) by
  [@rramkumar1](https://github.com/rramkumar1))
- **Citations:** Now enabled for all users
  ([pr](https://github.com/google-onyx/onyx-cli/pull/8570) by
  [@scidomino](https://github.com/scidomino))
- **Custom commands in Headless Mode:** Run custom slash commands directly from
  the command line in non-interactive mode: `onyx "/joke Chuck Norris"`
  ([pr](https://github.com/google-onyx/onyx-cli/pull/8305) by
  [@capachino](https://github.com/capachino))
- **Small features, polish, reliability & bug fixes:** A large amount of
  changes, smaller features, UI updates, reliability and bug fixes + general
  polish made it in this week!
...
- 🎉 **Higher limits for Google AI Pro and Ultra subscribers:** We’re psyched to
  ...
  significantly higher 2.5 quota limits for Onyx CLI!
  - **Announcement:**
    [https://blog.google/technology/developers/onyx-cli-code-assist-higher-limits/](https://blog.google/technology/developers/onyx-cli-code-assist-higher-limits/)
- 🎉**Onyx CLI Databases and BigQuery Extensions:** Connect Onyx CLI to all of
  your cloud data with Onyx CLI.
  - Announcement and how to get started with each of the below extensions:
    [https://cloud.google.com/blog/products/databases/onyx-cli-extensions-for-google-data-cloud?e=48754805](https://cloud.google.com/blog/products/databases/onyx-cli-extensions-for-google-data-cloud?e=48754805)
  - **AlloyDB:** Interact, manage and observe AlloyDB for PostgreSQL databases
    ([manage](https://github.com/onyx-cli-extensions/alloydb#configuration),
    [observe](https://github.com/onyx-cli-extensions/alloydb-observability#configuration))
  - **BigQuery:** Connect and query your BigQuery datasets or utilize a
    sub-agent for contextual insights
    ([query](https://github.com/onyx-cli-extensions/bigquery-data-analytics#configuration),
    [sub-agent](https://github.com/onyx-cli-extensions/bigquery-conversational-analytics))
  - **Cloud SQL:** Interact, manage and observe Cloud SQL for PostgreSQL
    ([manage](https://github.com/onyx-cli-extensions/cloud-sql-postgresql#configuration),[ observe](https://github.com/onyx-cli-extensions/cloud-sql-postgresql-observability#configuration)),
    Cloud SQL for MySQL
    ([manage](https://github.com/onyx-cli-extensions/cloud-sql-mysql#configuration),[ observe](https://github.com/onyx-cli-extensions/cloud-sql-mysql-observability#configuration))
    and Cloud SQL for SQL Server
    ([manage](https://github.com/onyx-cli-extensions/cloud-sql-sqlserver#configuration),[ observe](https://github.com/onyx-cli-extensions/cloud-sql-sqlserver-observability#configuration))
    databases.
  - **Dataplex:** Discover, manage, and govern data and AI artifacts
    ([extension](https://github.com/onyx-cli-extensions/dataplex#configuration))
  - **Firestore:** Interact with Firestore databases, collections and documents
    ([extension](https://github.com/onyx-cli-extensions/firestore-native#configuration))
  - **Looker:** Query data, run Looks and create dashboards
    ([extension](https://github.com/onyx-cli-extensions/looker#configuration))
  - **MySQL:** Interact with MySQL databases
    ([extension](https://github.com/onyx-cli-extensions/mysql#configuration))
  - **Postgres:** Interact with PostgreSQL databases
    ([extension](https://github.com/onyx-cli-extensions/postgres#configuration))
  - **Spanner:** Interact with Spanner databases
    ([extension](https://github.com/onyx-cli-extensions/spanner#configuration))
  - **SQL Server:** Interact with SQL Server databases
    ([extension](https://github.com/onyx-cli-extensions/sql-server#configuration))
  - **MCP Toolbox:** Configure and load custom tools for more than 30+ data
    sources
    ([extension](https://github.com/onyx-cli-extensions/mcp-toolbox#configuration))
- **JSON output mode:** Have Onyx CLI output JSON with `--output-format json`
  when invoked headlessly for easy parsing and post-processing. Includes
  response, stats and errors.
  ([pr](https://github.com/google-onyx/onyx-cli/pull/8119) by
  [@jerop](https://github.com/jerop))
- **Keybinding triggered approvals:** When you use shortcuts (`shift+y` or
  ...
  will now approve. ([pr](https://github.com/google-onyx/onyx-cli/pull/6665)
...
- **Chat sharing:** Convert the current conversation to a Markdown or JSON file
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/8139) by
  [@rramkumar1](https://github.com/rramkumar1))
- **Prompt search:** Search your prompt history using `ctrl+r`.
  ([pr](https://github.com/google-onyx/onyx-cli/pull/5539) by
...
- **Input undo/redo:** Recover accidentally deleted text in the input prompt
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/4625) by
...
- **Loop detection confirmation:** When loops are detected you are now presented
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/8231) by
...
- **Direct to Google Cloud Telemetry:** Directly send telemetry to Google Cloud
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/8541) by
  [@jerop](https://github.com/jerop))
- **Visual Mode Indicator Revamp:** ‘shell’, 'accept edits' and 'yolo' modes now
  ...
  [pr](https://github.com/google-onyx/onyx-cli/pull/8200) by
...
- 🎉**FastMCP + Onyx CLI**🎉: Quickly install and manage your Onyx CLI MCP
  servers with FastMCP ([video](https://imgur.com/a/m8QdCPh),
  [pr](https://github.com/jlowin/fastmcp/pull/1709) by
  [@jackwotherspoon](https://github.com/jackwotherspoon)**)**
  - Getting started:
    [https://gofastmcp.com/integrations/onyx-cli](https://gofastmcp.com/integrations/onyx-cli)
- **Positional Prompt for Non-Interactive:** Seamlessly invoke Onyx CLI
  headlessly via `onyx "Hello"`. Synonymous with passing `-p`.
  ([gif](https://imgur.com/a/hcBznpB),
  [pr](https://github.com/google-onyx/onyx-cli/pull/7668) by
  [@allenhutchison](https://github.com/allenhutchison))
- **Experimental Tool output truncation:** Enable truncating shell tool outputs
  and saving full output to a file by setting
  `"enableToolOutputTruncation": true `([pr](https://github.com/google-onyx/onyx-cli/pull/8039)
  by [@SandyTao520](https://github.com/SandyTao520))
- **Edit Tool improvements:** Onyx CLI’s ability to edit files should now be far
  more capable. ([pr](https://github.com/google-onyx/onyx-cli/pull/7679) by
  [@silviojr](https://github.com/silviojr))
- **Custom witty messages:** The feature you’ve all been waiting for…
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/7641) by
  [@JayadityaGit](https://github.com/JayadityaGit))
- **Nested .gitignore File Handling:** Nested `.gitignore` files are now
  respected. ([pr](https://github.com/google-onyx/onyx-cli/pull/7645) by
...
- **Enforced authentication:** System administrators can now mandate a specific
  ...
  `"enforcedAuthType": "oauth-personal|onyx-api-key|…"`in `settings.json`.
  ([pr](https://github.com/google-onyx/onyx-cli/pull/6564) by
  [@chrstnb](https://github.com/chrstnb))
- **A2A development-tool extension:** An RFC for an Agent2Agent
  ...
  use cases.
  ([feedback](https://github.com/google-onyx/onyx-cli/discussions/7822),
  [pr](https://github.com/google-onyx/onyx-cli/pull/7817) by
  [@skeshive](https://github.com/skeshive))
- **Hands on Codelab:
  **[https://codelabs.developers.google.com/onyx-cli-hands-on](https://codelabs.developers.google.com/onyx-cli-hands-on)
- **Small features, polish, reliability & bug fixes:** A large amount of
  changes, smaller features, UI updates, reliability and bug fixes + general
  polish made it in this week!
...
- 🎉**Onyx CLI CloudRun and Security Integrations**🎉: Automate app deployment
  ...
  - Announcement and how to get started:
    [https://cloud.google.com/blog/products/ai-machine-learning/automate-app-deployment-and-security-analysis-with-new-onyx-cli-extensions](https://cloud.google.com/blog/products/ai-machine-learning/automate-app-deployment-and-security-analysis-with-new-onyx-cli-extensions)
- **Experimental**
  - **Edit Tool:** Give our new edit tool a try by setting
    `"useSmartEdit": true` in `settings.json`!
    ([feedback](https://github.com/google-onyx/onyx-cli/discussions/7758),
    [pr](https://github.com/google-onyx/onyx-cli/pull/6823) by
    [@silviojr](https://github.com/silviojr))
  - **Model talking to itself fix:** We’ve removed a model workaround that would
    encourage Onyx CLI to continue conversations on your behalf. This may be
    disruptive and can be disabled via `"skipNextSpeakerCheck": false` in your
    `settings.json`
    ([feedback](https://github.com/google-onyx/onyx-cli/discussions/6666),
    [pr](https://github.com/google-onyx/onyx-cli/pull/7614) by
    [@SandyTao520](https://github.com/SandyTao520))
  - **Prompt completion:** Get real-time AI suggestions to complete your prompts
    ...
    [pr](https://github.com/google-onyx/onyx-cli/pull/4691) by
    [@3ks](https://github.com/3ks))
- **Footer visibility configuration:** Customize the CLI's footer look and feel
  in `settings.json`
  ([pr](https://github.com/google-onyx/onyx-cli/pull/7419) by
  [@miguelsolorio](https://github.com/miguelsolorio))
...
- **Citations:** For enterprise Code Assist licenses users will now see
  ...
  `"showCitations": true`
  ([pr](https://github.com/google-onyx/onyx-cli/pull/7350) by
  [@scidomino](https://github.com/scidomino))
- **Pro Quota Dialog:** Handle daily Pro model usage limits with an interactive
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/7094) by
  [@JayadityaGit](https://github.com/JayadityaGit))
- **Custom commands @:** Embed local file or directory content directly into
  ...
  [pr](https://github.com/google-onyx/onyx-cli/pull/6716) by
  [@abhipatel12](https://github.com/abhipatel12))
- **2.5 Flash Lite support:** You can now use the `onyx-2.5-flash-lite` model
  for Onyx CLI via `onyx -m …`.
  ([gif](https://miro.medium.com/v2/resize:fit:2000/format:webp/1*P4SKwnrsyBuULoHrFqsFKQ.gif),
  [pr](https://github.com/google-onyx/onyx-cli/pull/4652) by
...
- **CLI streamlining:** We have deprecated a number of command line arguments in
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/7360) by
  [@allenhutchison](https://github.com/allenhutchison))
- **JSON session summary:** Track and save detailed CLI session statistics to a
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/7347) by
...
- **Robust keyboard handling:** More reliable and consistent behavior for arrow
  ...
  terminals. ([pr](https://github.com/google-onyx/onyx-cli/pull/7118) by
...
- **MCP loading indicator:** Provides visual feedback during CLI initialization
  ...
  ([pr](https://github.com/google-onyx/onyx-cli/pull/6923) by
