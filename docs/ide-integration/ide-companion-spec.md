# Onyx CLI companion plugin: Interface specification
...
Onyx CLI and the IDE plugin communicate through a local communication channel.
...
For Onyx CLI to connect, it needs to discover which IDE instance it's running
