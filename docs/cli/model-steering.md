...
Model steering lets you provide real-time guidance and feedback to Onyx CLI
...
When model steering is enabled, Onyx CLI treats any text you type while the
...
Onyx CLI acknowledges your hint with a brief message and injects it directly
...
When you submit a steering hint, Onyx CLI performs the following actions:
