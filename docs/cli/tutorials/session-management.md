...
Resume, browse, and rewind your conversations with Onyx CLI. In this guide,
...
on a different feature. Onyx makes it easy to jump back in.
...
Onyx CLI's **Rewind** feature is like `Ctrl+Z` for your workflow.
...
Onyx gives you granular control over the undo process. You can choose to:
