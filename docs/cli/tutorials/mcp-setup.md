...
Connect Onyx CLI to your external databases and services. In this guide,
you'll learn how to extend Onyx CLI's capabilities by installing the GitHub
...
Restart Onyx CLI. It will automatically try to start the defined servers.
