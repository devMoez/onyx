# Onyx CLI model selection (`/model` command)

Select your Onyx CLI model. The `/model` command lets you configure the model
used by Onyx CLI, giving you more control over your results. Use **Pro**
...
Use the following command in Onyx CLI:
