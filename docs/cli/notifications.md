...
Onyx CLI can send system notifications to alert you when a session completes
...
notifications, Onyx CLI falls back to a terminal bell (BEL) to get your
...
Onyx CLI sends notifications for the following events:
