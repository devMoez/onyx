          ...
          paths: [
            {
              ...
              message:
                'Please use the helpers from @google/onyx-cli-core instead of node:os homedir()/tmpdir() to ensure strict environment isolation.',
            },
            {
              name: 'os',
              importNames: ['homedir', 'tmpdir'],
              message:
                'Please use the helpers from @google/onyx-cli-core instead of os homedir()/tmpdir() to ensure strict environment isolation.',
            },
          ],
        },
      ],
  ...
  },
  {
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          name: '@google/onyx-cli-core',
          message: 'Please use relative imports within the @google/onyx-cli-core package.',
        },
      ],
    },
  },
  {
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          name: '@google/onyx-cli',
          message: 'Please use relative imports within the @google/onyx-cli package.',
        },
      ],
    },
  },
  {
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          name: '@google/onyx-cli-sdk',
          message: 'Please use relative imports within the @google/onyx-cli-sdk package.',
        },
      ],
    },
  },
