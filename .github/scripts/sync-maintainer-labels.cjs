 ...
 * - Skips DUPLICATES.
 * - Skips Pull Requests.
 * - ONLY labels issues in the PUBLIC (onyx-cli) repo.
 */

const REPO_OWNER = 'google-onyx';
const PUBLIC_REPO = 'onyx-cli';
const PRIVATE_REPO = 'maintainers-onyx-cli';
 ...
 * e.g. - [ ] #123 or - [x] google-onyx/onyx-cli#123
 */
