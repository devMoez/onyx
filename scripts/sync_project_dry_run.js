...
const MAINTAINERS_REPO = 'google-onyx/maintainers-onyx-cli';
...
async function run() {
  ...
  console.log(`
Total Open Onyx Issues: ${issues.length}`);
  ...
  for (const item of currentItems) {
    ...
    if (
      ...
      (item.content.url && item.content.url.includes('maintainers-onyx-cli'))
    ) {
      continue;
    }
