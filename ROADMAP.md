...
- **Intelligent:** Onyx CLI should be reliably ranked among the best agentic
...
- **Extensibility:** Bringing Onyx CLI to other surfaces e.g. GitHub.
...
- **Write Documentation:** Help us improve our documentation, tutorials, and
  examples. We are excited about the future of Onyx CLI and look forward to
