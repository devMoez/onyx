...
import { isWithinRoot, type FileSystemService } from '@onyx/core';
...
export class AcpFileSystemService implements FileSystemService {
  private readonly onyxDir = path.join(os.homedir(), '.onyx');
  ...
  private shouldUseFallback(filePath: string): boolean {
    ...
    return (
      !isWithinRoot(filePath, this.root) || isWithinRoot(filePath, this.onyxDir)
    );
  }
