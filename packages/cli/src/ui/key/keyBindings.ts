...
import { isNodeError, Storage } from '@onyx/core';
...
export const commandDescriptions: Readonly<Record<Command, string>> = {
  ...
  [Command.FOCUS_SHELL_INPUT]: 'Move focus from Onyx to the active shell.',
  [Command.UNFOCUS_SHELL_INPUT]: 'Move focus from the shell back to Onyx.',
  ...
  [Command.UNFOCUS_BACKGROUND_SHELL]:
    'Move focus from background shell to Onyx.',
  [Command.UNFOCUS_BACKGROUND_SHELL_LIST]:
    'Move focus from background shell list to Onyx.',
  [Command.SHOW_BACKGROUND_SHELL_UNFOCUS_WARNING]:
