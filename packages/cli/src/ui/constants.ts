...
// usage.
export const MAX_ONYX_MESSAGE_LINES = 65536;
...
export const KEYBOARD_SHORTCUTS_URL =
  'https://onyxcli.com/docs/cli/keyboard-shortcuts/';
...
export const SKILLS_DOCS_URL =
  'https://github.com/google-onyx/onyx-cli/blob/main/docs/cli/skills.md';
