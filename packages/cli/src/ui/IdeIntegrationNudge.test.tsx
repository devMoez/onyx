...
describe('IdeIntegrationNudge', () => {
  ...
  beforeEach(() => {
    ...
    vi.stubEnv('ONYX_CLI_IDE_WORKSPACE_PATH', '');
  });
  ...
  it('renders correctly with default options', async () => {
    ...
    expect(frame).toContain('Do you want to connect VS Code to Onyx CLI?');
  ...
  it('displays correct text and handles selection when extension is pre-installed', async () => {
    vi.stubEnv('ONYX_CLI_IDE_SERVER_PORT', '1234');
    vi.stubEnv('ONYX_CLI_IDE_WORKSPACE_PATH', '/tmp');
