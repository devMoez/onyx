...
export const CloudFreePrivacyNotice = ({
    ...
    return (
      <Box flexDirection="column" marginY={1}>
        <Text bold color={theme.text.accent}>
          Onyx Code Assist Privacy Notice
        </Text>
        <Newline />
        <Text>
          https://developers.google.com/onyx-code-assist/resources/privacy-notices
        </Text>
        <Newline />
        <Text color={theme.text.secondary}>Press Esc to exit.</Text>
      </Box>
  ...
  return (
    <Box flexDirection="column" marginY={1}>
      <Text bold color={theme.text.accent}>
        Onyx Code Assist for Individuals Privacy Notice
      </Text>
      <Newline />
      <Text color={theme.text.primary}>
        This notice and our Privacy Policy
        <Text color={theme.text.link}>[1]</Text> describe how Onyx Code Assist
        handles your data. Please read them carefully.
      </Text>
      <Newline />
      <Text color={theme.text.primary}>
        When you use Onyx Code Assist for individuals with Onyx CLI, Google
