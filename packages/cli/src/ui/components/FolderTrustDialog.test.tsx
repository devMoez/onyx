...
import { makeFakeConfig, ExitCodes } from '@onyx/core';
...
describe('FolderTrustDialog', () => {
  ...
  it('should render the dialog with title and description', async () => {
    ...
    expect(lastFrame()).toContain(
      'Trusting a folder allows Onyx CLI to load its local configurations',
    );
    unmount();
  });
  ...
  it('should display restart message when isRestarting is true', async () => {
    ...
    expect(lastFrame()).toContain('Onyx CLI is restarting');
    unmount();
  });
