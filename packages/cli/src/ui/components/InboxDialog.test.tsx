...
const inboxPatch: InboxPatch = {
  ...
  entries: [
    {
      targetPath: '/home/user/.onyx/skills/docs-writer/SKILL.md',
      diffContent: [
        '--- /home/user/.onyx/skills/docs-writer/SKILL.md',
        '+++ /home/user/.onyx/skills/docs-writer/SKILL.md',
        '@@ -1,3 +1,4 @@',
        ' line1',
        ' line2',
...
const inboxMemoryPatch: InboxMemoryPatch = {
  ...
  entries: [
    {
      targetPath: '/home/user/.onyx/tmp/project/memory/MEMORY.md',
      isNewFile: false,
      diffContent: [
        '--- /home/user/.onyx/tmp/project/memory/MEMORY.md',
        '+++ /home/user/.onyx/tmp/project/memory/MEMORY.md',
        '@@ -1,1 +1,1 @@',
        '-old',
        '+use focused tests',
...
const workspacePatch: InboxPatch = {
  ...
  entries: [
    {
      targetPath: '/repo/.onyx/skills/docs-writer/SKILL.md',
      diffContent: [
        '--- /repo/.onyx/skills/docs-writer/SKILL.md',
        '+++ /repo/.onyx/skills/docs-writer/SKILL.md',
        '@@ -1,1 +1,2 @@',
        ' line1',
        '+line2',
...
const windowsGlobalPatch: InboxPatch = {
  ...
  entries: [
    {
      targetPath: 'C:\\Users\\sandy\\.onyx\\skills\\docs-writer\\SKILL.md',
      diffContent: [
        '--- C:\\Users\\sandy\\.onyx\\skills\\docs-writer\\SKILL.md',
        '+++ C:\\Users\\sandy\\.onyx\\skills\\docs-writer\\SKILL.md',
        '@@ -1,1 +1,2 @@',
        ' line1',
        '+line2',
...
describe('InboxDialog', () => {
  beforeEach(() => {
    ...
    mockMoveInboxSkill.mockResolvedValue({
      success: true,
      message: 'Moved "inbox-skill" to ~/.onyx/skills.',
    });
  ...
  it('shows inline feedback when reloading skills fails after a move', async () => {
    ...
    await waitFor(() => {
      expect(lastFrame()).toContain(
        'Moved "inbox-skill" to ~/.onyx/skills. Failed to reload skills: reload hook failed',
      );
    });
  ...
  describe('patch support', () => {
    it('shows patches alongside skills with section headers', async () => {
      ...
      const config = {
        isTrustedFolder: vi.fn().mockReturnValue(true),
        storage: {
          getProjectSkillsDir: vi.fn().mockReturnValue('/repo/.onyx/skills'),
        },
      } as unknown as Config;
    ...
    it('disables Apply for workspace patches in an untrusted workspace', async () => {
      ...
      await waitFor(() => {
        ...
        expect(frame).toContain(
          '.onyx/skills — unavailable until this workspace is trusted',
        );
      });
      ...
      const config = {
        ...
        storage: {
          getProjectSkillsDir: vi
            .fn()
            .mockReturnValue('/symlinked/workspace/.onyx/skills'),
        },
      } as unknown as Config;
      const { lastFrame, stdin, unmount, waitUntilReady } = await act(
        async () =>
    ...
    it('shows Windows patch entries with a basename and origin tag', async () => {
      ...
      const config = {
        ...
        storage: {
          getProjectSkillsDir: vi
            .fn()
            .mockReturnValue('C:\\repo\\.onyx\\skills'),
        },
      } as unknown as Config;
      const { lastFrame, unmount } = await act(async () =>
        renderWithProviders(
      ...
      await waitFor(() => {
        ...
        expect(frame).not.toContain('C:\\Users\\sandy\\.onyx\\skills');
      });
