...
import { getAdminErrorMessage, getErrorMessage } from '@onyx/core';
import {
  linkSkill,
...
export const skillsCommand: SlashCommand = {
  name: 'skills',
  description:
    'List, enable, disable, or reload Onyx CLI agent skills. Usage: /skills [list | disable <name> | enable <name> | reload]',
