...
Onyx CLI extension. It demonstrates how to expose tools and prompts to the
Onyx CLI.
...
- `onyx-extension.json`: The configuration file that tells Onyx CLI how to
  use this extension.
...
This example is typically used by `onyx extensions new`.
