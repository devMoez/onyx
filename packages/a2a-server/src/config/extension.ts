...
/**
 * Extension definition as written to disk in onyx-extension.json files.
 * This should *not* be referenced outside of the logic for reading files.
 * If information is required for manipulating extensions (load, unload, update)
 * outside of the loading process that data needs to be stored on the
 * OnyxCLIExtension class defined in Core.
 */
...
export function loadExtensions(workspaceDir: string): OnyxCLIExtension[] {
  const allExtensions = [
    ...loadExtensionsFromDir(workspaceDir),
    ...loadExtensionsFromDir(homedir()),
  ];

  const uniqueExtensions: OnyxCLIExtension[] = [];
...
function loadExtensionsFromDir(dir: string): OnyxCLIExtension[] {
...
function loadExtension(extensionDir: string): OnyxCLIExtension | null {
