# RFC: Onyx CLI A2A Development-Tool Extension

## 1. Introduction

### 1.1 Overview

To standardize client integrations with the Onyx CLI agent, this document
...
required for rich, interactive workflows with the Onyx CLI agent.

### 1.2 Motivation

Recent work integrating Onyx CLI with clients like Zed and Onyx Code
...
- **Ecosystem Alignment**: Aligns Onyx CLI with a growing industry standard,
...
workflows between a client and the Onyx CLI agent. It consists of a
...
```json
{
  ...
  "capabilities": {
    ...
    "extensions": [
      {
        "uri": "https://github.com/google-onyx/onyx-cli/blob/main/docs/a2a/developer-profile/v0/spec.md",
...
// Configuration settings for the Onyx CLI agent.
...
This method allows the client to discover slash commands supported by Onyx
