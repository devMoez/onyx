...
describe('getIdeProcessInfo', () => {
  ...
  describe('ONYX_CLI_IDE_PID override', () => {
    it('should use ONYX_CLI_IDE_PID and fetch command on Unix', async () => {
      (os.platform as Mock).mockReturnValue('linux');
      vi.stubEnv('ONYX_CLI_IDE_PID', '12345');
    ...
    it('should use ONYX_CLI_IDE_PID and fetch command on Windows', async () => {
      (os.platform as Mock).mockReturnValue('win32');
      vi.stubEnv('ONYX_CLI_IDE_PID', '54321');
      const processes = [
        {
          ProcessId: 54321,
          ParentProcessId: 0,
