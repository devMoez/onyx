...
/**
 * A native C# helper for the Onyx CLI sandbox on Windows.
...
public class OnyxSandbox {
    ...
    static int Main(string[] args) {
        if (args.Length < 3) {
            Console.Error.WriteLine("Usage: OnyxSandbox.exe <network:0|1> <cwd> [--forbidden-manifest <path>] [--allowed-manifest <path>] <command> [args...]");
