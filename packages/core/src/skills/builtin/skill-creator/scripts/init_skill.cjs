...
**Note:** Scripts may be executed without loading into context, but can still be read by Onyx CLI for patching or environment adjustments.

### references/
Documentation and reference material intended to be loaded into context to inform Onyx CLI's process and thinking.
...
**Appropriate for:** In-depth documentation, API references, database schemas, comprehensive guides, or any detailed information that Onyx CLI should reference while working.
