...
/**
 * Decoupled LLM request format - stable across Onyx CLI versions
 */
...
/**
 * Decoupled LLM response format - stable across Onyx CLI versions
 */
...
/**
 * Decoupled tool configuration - stable across Onyx CLI versions
 */
...
export class HookTranslatorGenAIv1 extends HookTranslator {
  ...
  fromHookLLMRequest(
    ...
    // (see https://github.com/google-onyx/onyx-cli/issues/25558).
    //
