...
describe('HookRunner', () => {
    ...
    describe('command hooks', () => {
      ...
      it('should expand environment variables in commands', async () => {
        const configWithEnvVar: HookConfig = {
          type: HookType.Command,
          command: '$ONYX_PROJECT_DIR/hooks/test.sh',
        };
        ...
        expect(spawn).toHaveBeenCalledWith(
          ...
          expect.objectContaining({
            ...
            env: expect.objectContaining({
              ONYX_PROJECT_DIR: '/test/project',
              ONYX_PLANS_DIR: '/test/project/plans',
              ONYX_CWD: '/test/project',
              ONYX_SESSION_ID: 'test-session',
      ...
      it('should expand and escape ONYX_PLANS_DIR in commands', async () => {
        const configWithEnvVar: HookConfig = {
          type: HookType.Command,
          command: 'ls $ONYX_PLANS_DIR',
        };
      ...
      it('should not allow command injection via ONYX_PROJECT_DIR', async () => {
  ...
  describe('executeHooksSequential', () => {
    ...
    it('should pass modified LLM request from one hook to the next for BeforeModel', async () => {
      ...
      expect(secondHookInput.llm_request.model).toBe('onyx-1.5-pro');
