...
describe('SessionSummaryService', () => {
  ...
  describe('Message Type Filtering', () => {
    it('should include only user and onyx messages', async () => {
      const messages: MessageRecord[] = [
        {
          id: '1',
          timestamp: '2025-12-03T00:00:00Z',
      ...
      expect(promptText).toContain('Assistant: Onyx response');
    });
    ...
    it('should handle mixed message types correctly', async () => {
      ...
      expect(promptText).toContain('Assistant: Onyx answer');
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle conversation with only onyx messages', async () => {
      const messages: MessageRecord[] = [
        {
          id: '1',
          timestamp: '2025-12-03T00:00:00Z',
