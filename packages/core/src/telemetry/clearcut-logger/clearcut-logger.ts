...
export interface EventValue {
  onyx_cli_key: EventMetadataKey;
  value: string;
}

export interface LogEvent {
  console_type: 'ONYX_CLI';
  application: number;
  event_name: string;
 ...
 * distribution channel in which the user is using Onyx CLI.  Onyx CLI comes bundled
...
export class ClearcutLogger {
      ...
      this.config?.getExperimentsAsync().then((experiments) => {
        if (experiments) {
          const exp_id_data: EventValue[] = [
            {
              onyx_cli_key: EventMetadataKey.ONYX_CLI_EXPERIMENT_IDS,
  ...
  createBasicLogEvent(
    ...
    if (this.hashedGHRepositoryName) {
      baseMetadata.push({
        onyx_cli_key: EventMetadataKey.ONYX_CLI_GH_REPOSITORY_NAME_HASH,
  ...
  async logStartSessionEvent(event: StartSessionEvent): Promise<void> {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_START_SESSION_MODEL,
        value: event.model,
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_START_SESSION_EMBEDDING_MODEL,
        value: event.embedding_model,
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_START_SESSION_SANDBOX,
        value: event.sandbox_enabled.toString(),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_START_SESSION_CORE_TOOLS,
        value: event.core_tools_enabled,
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_START_SESSION_APPROVAL_MODE,
        value: event.approval_mode,
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_START_SESSION_API_KEY_ENABLED,
        value: event.api_key_enabled.toString(),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_START_SESSION_VERTEX_API_ENABLED,
        value: event.vertex_ai_enabled.toString(),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_START_SESSION_DEBUG_MODE_ENABLED,
      ...
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_START_SESSION_MCP_SERVERS,
      ...
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_START_SESSION_TELEMETRY_ENABLED,
        value: event.telemetry_enabled.toString(),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_START_SESSION_TELEMETRY_LOG_USER_PROMPTS_ENABLED,
        value: event.telemetry_log_user_prompts_enabled.toString(),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_START_SESSION_MCP_SERVERS_COUNT,
      ...
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_START_SESSION_MCP_TOOLS_COUNT,
        value: event.mcp_tools_count?.toString() ?? '',
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_START_SESSION_MCP_TOOLS,
        value: event.mcp_tools ? event.mcp_tools : '',
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_START_SESSION_EXTENSIONS_COUNT,
        value: event.extensions_count.toString(),
      },
      // We deliberately do not log the names of extensions here, to be safe.
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_START_SESSION_EXTENSION_IDS,
        value: event.extension_ids.toString(),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_START_SESSION_WORKTREE_ACTIVE,
    ...
    if (cpus && cpus.length > 0) {
      data.push({
        onyx_cli_key: EventMetadataKey.ONYX_CLI_CPU_INFO,
        value: cpus[0].model,
      });
    }
    ...
    data.push(
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_CPU_CORES,
        value: os.availableParallelism().toString(),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_RAM_TOTAL_GB,
  ...
  logNewPromptEvent(event: UserPromptEvent): void {
    ...
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_USER_PROMPT_LENGTH,
  ...
  logToolCallEvent(event: ToolCallEvent): void {
    const data: EventValue[] = [
      ...
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_TOOL_CALL_DECISION,
        value: JSON.stringify(event.decision),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_TOOL_CALL_SUCCESS,
        value: JSON.stringify(event.success),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_TOOL_CALL_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_TOOL_CALL_ERROR_TYPE,
        value: JSON.stringify(event.error_type),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_TOOL_TYPE,
        value: JSON.stringify(event.tool_type),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_TOOL_CALL_CONTENT_LENGTH,
        value: JSON.stringify(event.content_length),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_TOOL_CALL_MCP_SERVER_NAME,
    ...
    if (event.metadata) {
      const metadataMapping: { [key: string]: EventMetadataKey } = {
        model_added_lines: EventMetadataKey.ONYX_CLI_AI_ADDED_LINES,
        model_removed_lines: EventMetadataKey.ONYX_CLI_AI_REMOVED_LINES,
        model_added_chars: EventMetadataKey.ONYX_CLI_AI_ADDED_CHARS,
        model_removed_chars: EventMetadataKey.ONYX_CLI_AI_REMOVED_CHARS,
        user_added_lines: EventMetadataKey.ONYX_CLI_USER_ADDED_LINES,
        user_removed_lines: EventMetadataKey.ONYX_CLI_USER_REMOVED_LINES,
        user_added_chars: EventMetadataKey.ONYX_CLI_USER_ADDED_CHARS,
        user_removed_chars: EventMetadataKey.ONYX_CLI_USER_REMOVED_CHARS,
      };
      ...
      if (
        ...
        const askUserMapping: { [key: string]: EventMetadataKey } = {
          question_types: EventMetadataKey.ONYX_CLI_ASK_USER_QUESTION_TYPES,
          dismissed: EventMetadataKey.ONYX_CLI_ASK_USER_DISMISSED,
          empty_submission:
            EventMetadataKey.ONYX_CLI_ASK_USER_EMPTY_SUBMISSION,
          answer_count: EventMetadataKey.ONYX_CLI_ASK_USER_ANSWER_COUNT,
        };

        for (const [key, onyx_cli_key] of Object.entries(askUserMapping)) {
      ...
      for (const [key, onyx_cli_key] of Object.entries(metadataMapping)) {
    ...
    if (event.extension_id) {
      data.push({
        onyx_cli_key: EventMetadataKey.ONYX_CLI_EXTENSION_ID,
  ...
  logFileOperationEvent(event: FileOperationEvent): void {
    const data: EventValue[] = [
      ...
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_FILE_OPERATION_TYPE,
        value: JSON.stringify(event.operation),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_FILE_OPERATION_LINES,
        value: JSON.stringify(event.lines),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_FILE_OPERATION_MIMETYPE,
        value: JSON.stringify(event.mimetype),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_FILE_OPERATION_EXTENSION,
    ...
    if (event.programming_language) {
      data.push({
        onyx_cli_key: EventMetadataKey.ONYX_CLI_PROGRAMMING_LANGUAGE,
  ...
  logApiRequestEvent(event: ApiRequestEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_API_REQUEST_MODEL,
  ...
  logApiResponseEvent(event: ApiResponseEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_API_RESPONSE_MODEL,
        value: JSON.stringify(event.model),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_API_RESPONSE_STATUS_CODE,
        value: JSON.stringify(event.status_code),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_API_RESPONSE_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_API_RESPONSE_INPUT_TOKEN_COUNT,
        value: JSON.stringify(event.usage.input_token_count),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_API_RESPONSE_OUTPUT_TOKEN_COUNT,
        value: JSON.stringify(event.usage.output_token_count),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_API_RESPONSE_CACHED_TOKEN_COUNT,
        value: JSON.stringify(event.usage.cached_content_token_count),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_API_RESPONSE_THINKING_TOKEN_COUNT,
        value: JSON.stringify(event.usage.thoughts_token_count),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_API_RESPONSE_TOOL_TOKEN_COUNT,
      ...
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_SYSTEM_INSTRUCTIONS,
      ...
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_TOOL_DEFINITIONS,
        value: JSON.stringify(
      ...
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_HISTORY,
        value: JSON.stringify(event.usage.context_breakdown?.history ?? 0),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_TOOL_CALLS,
        value: JSON.stringify(event.usage.context_breakdown?.tool_calls ?? {}),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_MCP_SERVERS,
  ...
  logApiErrorEvent(event: ApiErrorEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_API_ERROR_MODEL,
        value: JSON.stringify(event.model),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_API_ERROR_TYPE,
        value: JSON.stringify(event.error_type),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_API_ERROR_STATUS_CODE,
        value: JSON.stringify(event.status_code),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_API_ERROR_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
    ];
  ...
  logChatCompressionEvent(event: ChatCompressionEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_COMPRESSION_TOKENS_BEFORE,
        value: `${event.tokens_before}`,
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_COMPRESSION_TOKENS_AFTER,
  ...
  logLoopDetectedEvent(event: LoopDetectedEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_LOOP_DETECTED_TYPE,
    ...
    if (event.confirmed_by_model) {
      data.push({
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_LOOP_DETECTED_CONFIRMED_BY_MODEL,
  ...
  logNextSpeakerCheck(event: NextSpeakerCheckEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_RESPONSE_FINISH_REASON,
        value: JSON.stringify(event.finish_reason),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_NEXT_SPEAKER_CHECK_RESULT,
  ...
  logSlashCommandEvent(event: SlashCommandEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_SLASH_COMMAND_NAME,
    ...
    if (event.subcommand) {
      data.push({
        onyx_cli_key: EventMetadataKey.ONYX_CLI_SLASH_COMMAND_SUBCOMMAND,
    ...
    if (event.status) {
      data.push({
        onyx_cli_key: EventMetadataKey.ONYX_CLI_SLASH_COMMAND_STATUS,
  ...
  logRewindEvent(event: RewindEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_REWIND_OUTCOME,
        value: event.outcome,
      },
    ];
  ...
  logMalformedJsonResponseEvent(event: MalformedJsonResponseEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_MALFORMED_JSON_RESPONSE_MODEL,
        value: JSON.stringify(event.model),
      },
    ];
  ...
  logIdeConnectionEvent(event: IdeConnectionEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_IDE_CONNECTION_TYPE,
  ...
  logConversationFinishedEvent(event: ConversationFinishedEvent): void {
    const data: EventValue[] = [
      ...
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_CONVERSATION_TURN_COUNT,
        value: JSON.stringify(event.turnCount),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_APPROVAL_MODE,
  ...
  logInvalidChunkEvent(event: InvalidChunkEvent): void {
    ...
    if (event.error_message) {
      data.push({
        onyx_cli_key: EventMetadataKey.ONYX_CLI_INVALID_CHUNK_ERROR_MESSAGE,
  ...
  logContentRetryEvent(event: ContentRetryEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_CONTENT_RETRY_ATTEMPT_NUMBER,
        value: String(event.attempt_number),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_CONTENT_RETRY_ERROR_TYPE,
        value: event.error_type,
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_CONTENT_RETRY_DELAY_MS,
  ...
  logContentRetryFailureEvent(event: ContentRetryFailureEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_CONTENT_RETRY_FAILURE_TOTAL_ATTEMPTS,
        value: String(event.total_attempts),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_CONTENT_RETRY_FAILURE_FINAL_ERROR_TYPE,
    ...
    if (event.total_duration_ms) {
      data.push({
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_CONTENT_RETRY_FAILURE_TOTAL_DURATION_MS,
  ...
  logNetworkRetryAttemptEvent(event: NetworkRetryAttemptEvent): void {
    // This event is generic for any retry attempt (Onyx, WebFetch, etc.)
    const data: EventValue[] = [
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_NETWORK_RETRY_ATTEMPT_NUMBER,
        value: String(event.attempt),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_NETWORK_RETRY_DELAY_MS,
        value: String(event.delay_ms),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_NETWORK_RETRY_ERROR_TYPE,
        value: event.error_type,
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_API_REQUEST_MODEL,
  ...
  async logExtensionInstallEvent(event: ExtensionInstallEvent): Promise<void> {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_EXTENSION_NAME,
      ...
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_EXTENSION_VERSION,
        value: event.extension_version,
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_EXTENSION_SOURCE,
        value: event.extension_source,
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_EXTENSION_INSTALL_STATUS,
        value: event.status,
      },
    ];
  ...
  async logExtensionUninstallEvent(
    ...
    const data: EventValue[] = [
      ...
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_EXTENSION_UNINSTALL_STATUS,
        value: event.status,
      },
    ];
  ...
  async logExtensionUpdateEvent(event: ExtensionUpdateEvent): Promise<void> {
    const data: EventValue[] = [
      ...
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_EXTENSION_PREVIOUS_VERSION,
      ...
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_EXTENSION_UPDATE_STATUS,
        value: event.status,
      },
    ];
  ...
  logToolOutputTruncatedEvent(event: ToolOutputTruncatedEvent): void {
    const data: EventValue[] = [
      ...
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_TOOL_OUTPUT_TRUNCATED_ORIGINAL_LENGTH,
        value: JSON.stringify(event.original_content_length),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_TOOL_OUTPUT_TRUNCATED_TRUNCATED_LENGTH,
        value: JSON.stringify(event.truncated_content_length),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_TOOL_OUTPUT_TRUNCATED_THRESHOLD,
  ...
  logToolOutputMaskingEvent(event: ToolOutputMaskingEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_TOOL_OUTPUT_MASKING_TOKENS_BEFORE,
        value: event.tokens_before.toString(),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_TOOL_OUTPUT_MASKING_TOKENS_AFTER,
        value: event.tokens_after.toString(),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_TOOL_OUTPUT_MASKING_MASKED_COUNT,
        value: event.masked_count.toString(),
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_TOOL_OUTPUT_MASKING_TOTAL_PRUNABLE_TOKENS,
  ...
  logModelRoutingEvent(event: ModelRoutingEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_ROUTING_DECISION,
        value: event.decision_model,
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_ROUTING_DECISION_SOURCE,
        value: event.decision_source,
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_ROUTING_LATENCY_MS,
        value: event.routing_latency_ms.toString(),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_ROUTING_FAILURE,
    ...
    if (event.error_message) {
      data.push({
        onyx_cli_key: EventMetadataKey.ONYX_CLI_ROUTING_FAILURE_REASON,
        value: event.error_message,
      });
    }
    ...
    if (event.reasoning && this.config?.getTelemetryLogPromptsEnabled()) {
      data.push({
        onyx_cli_key: EventMetadataKey.ONYX_CLI_ROUTING_REASONING,
    ...
    if (event.enable_numerical_routing !== undefined) {
      data.push({
        onyx_cli_key: EventMetadataKey.ONYX_CLI_ROUTING_NUMERICAL_ENABLED,
  ...
  async logExtensionEnableEvent(event: ExtensionEnableEvent): Promise<void> {
    const data: EventValue[] = [
      ...
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_EXTENSION_ENABLE_SETTING_SCOPE,
  ...
  logModelSlashCommandEvent(event: ModelSlashCommandEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_MODEL_SLASH_COMMAND,
  ...
  async logExtensionDisableEvent(event: ExtensionDisableEvent): Promise<void> {
    const data: EventValue[] = [
      ...
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_EXTENSION_DISABLE_SETTING_SCOPE,
        value: event.setting_scope,
      },
    ];
  ...
  logEditStrategyEvent(event: EditStrategyEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_EDIT_STRATEGY,
  ...
  logEditCorrectionEvent(event: EditCorrectionEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_EDIT_CORRECTION,
  ...
  logAgentStartEvent(event: AgentStartEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_AGENT_ID,
        value: event.agent_id,
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_AGENT_NAME,
  ...
  logAgentFinishEvent(event: AgentFinishEvent): void {
    const data: EventValue[] = [
      ...
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_AGENT_DURATION_MS,
        value: event.duration_ms.toString(),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_AGENT_TURN_COUNT,
        value: event.turn_count.toString(),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_AGENT_TERMINATE_REASON,
  ...
  logRecoveryAttemptEvent(event: RecoveryAttemptEvent): void {
    const data: EventValue[] = [
      ...
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_AGENT_RECOVERY_REASON,
        value: event.reason,
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_AGENT_RECOVERY_DURATION_MS,
        value: event.duration_ms.toString(),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_AGENT_RECOVERY_SUCCESS,
  ...
  logWebFetchFallbackAttemptEvent(event: WebFetchFallbackAttemptEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_WEB_FETCH_FALLBACK_REASON,
        value: event.reason,
      },
    ];
  ...
  logLlmLoopCheckEvent(event: LlmLoopCheckEvent): void {
    const data: EventValue[] = [
      ...
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_LLM_LOOP_CHECK_FLASH_CONFIDENCE,
        value: event.flash_confidence.toString(),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_LLM_LOOP_CHECK_MAIN_MODEL,
        value: event.main_model,
      },
      {
        onyx_cli_key:
          EventMetadataKey.ONYX_CLI_LLM_LOOP_CHECK_MAIN_MODEL_CONFIDENCE,
  ...
  logHookCallEvent(event: HookCallEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_HOOK_EVENT_NAME,
        value: event.hook_event_name,
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_HOOK_DURATION_MS,
        value: event.duration_ms.toString(),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_HOOK_SUCCESS,
        value: event.success.toString(),
      },
    ];
    ...
    if (event.exit_code !== undefined) {
      data.push({
        onyx_cli_key: EventMetadataKey.ONYX_CLI_HOOK_EXIT_CODE,
  ...
  logApprovalModeSwitchEvent(event: ApprovalModeSwitchEvent): void {
    const data: EventValue[] = [
      ...
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_APPROVAL_MODE_TO,
        value: event.to_mode,
      },
    ];
  ...
  logApprovalModeDurationEvent(event: ApprovalModeDurationEvent): void {
    const data: EventValue[] = [
      ...
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_APPROVAL_MODE_DURATION_MS,
        value: event.duration_ms.toString(),
      },
    ];
  ...
  logKeychainAvailabilityEvent(event: KeychainAvailabilityEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_KEYCHAIN_AVAILABLE,
  ...
  logTokenStorageInitializationEvent(
    ...
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_TOKEN_STORAGE_TYPE,
        value: event.type,
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_TOKEN_STORAGE_FORCED,
  ...
  logOnboardingStartEvent(_event: OnboardingStartEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_ONBOARDING_START,
        value: 'true',
      },
    ];
    this.enqueueLogEvent(
  ...
  logOnboardingSuccessEvent(event: OnboardingSuccessEvent): void {
    ...
    if (event.userTier) {
      data.push({
        onyx_cli_key: EventMetadataKey.ONYX_CLI_ONBOARDING_USER_TIER,
        value: event.userTier,
      });
    }
    if (event.duration_ms !== undefined) {
      data.push({
        onyx_cli_key: EventMetadataKey.ONYX_CLI_ONBOARDING_DURATION_MS,
        value: event.duration_ms.toString(),
      });
    }
    this.enqueueLogEvent(
  ...
  logStartupStatsEvent(event: StartupStatsEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_STARTUP_PHASES,
        value: JSON.stringify(event.phases),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_STARTUP_OS_PLATFORM,
        value: event.os_platform,
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_STARTUP_OS_RELEASE,
        value: event.os_release,
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_STARTUP_IS_DOCKER,
  ...
  logCreditsUsedEvent(event: CreditsUsedEvent): void {
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_BILLING_MODEL,
        value: JSON.stringify(event.model),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_BILLING_CREDITS_CONSUMED,
        value: JSON.stringify(event.credits_consumed),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_BILLING_CREDITS_REMAINING,
  ...
  logOverageOptionSelectedEvent(event: OverageOptionSelectedEvent): void {
    const data: EventValue[] = [
      ...
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_BILLING_SELECTED_OPTION,
        value: JSON.stringify(event.selected_option),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_BILLING_CREDIT_BALANCE,
  ...
  logCreditPurchaseClickEvent(event: CreditPurchaseClickEvent): void {
    const data: EventValue[] = [
      ...
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_BILLING_PURCHASE_SOURCE,
  ...
  logBrowserAgentConnectionEvent(attrs: {
    ...
    const data: EventValue[] = [
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_BROWSER_AGENT_SESSION_MODE,
        value: attrs.session_mode,
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_BROWSER_AGENT_HEADLESS,
        value: attrs.headless.toString(),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_BROWSER_AGENT_SUCCESS,
        value: attrs.success.toString(),
      },
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_BROWSER_AGENT_DURATION_MS,
    ...
    if (attrs.error_type) {
      data.push({
        onyx_cli_key: EventMetadataKey.ONYX_CLI_BROWSER_AGENT_ERROR_TYPE,
    ...
    if (attrs.tool_count !== undefined) {
      data.push({
        onyx_cli_key: EventMetadataKey.ONYX_CLI_BROWSER_AGENT_TOOL_COUNT,
  ...
  addDefaultFields(data: EventValue[], totalAccounts: number): EventValue[] {
    const defaultLogMetadata: EventValue[] = [
      ...
      {
        onyx_cli_key: EventMetadataKey.ONYX_CLI_INTERACTIVE,
