...
export enum EventMetadataKey {
  ...
  ONYX_CLI_USER_PROMPT_LENGTH = 13,
  ...
  ONYX_CLI_TOOL_CALL_NAME = 14,

  // Logs the MCP server name.
  ONYX_CLI_TOOL_CALL_MCP_SERVER_NAME = 95,

  // Logs the user's decision about how to handle the tool call.
  ONYX_CLI_TOOL_CALL_DECISION = 15,

  // Logs whether the tool call succeeded.
  ONYX_CLI_TOOL_CALL_SUCCESS = 16,

  // Logs the tool call duration in milliseconds.
  ONYX_CLI_TOOL_CALL_DURATION_MS = 17,

  // Do not use.
  DEPRECATED_ONYX_CLI_TOOL_ERROR_MESSAGE = 18,

  // Logs the tool call error type, if any.
  ONYX_CLI_TOOL_CALL_ERROR_TYPE = 19,

  // Logs the length of tool output
  ONYX_CLI_TOOL_CALL_CONTENT_LENGTH = 93,
  ...
  ONYX_CLI_EDIT_STRATEGY = 109,

  // Logs a edit correction event.
  ONYX_CLI_EDIT_CORRECTION = 110,

  // Logs the reason for web fetch fallback.
  ONYX_CLI_WEB_FETCH_FALLBACK_REASON = 116,
  ...
  ONYX_CLI_API_RESPONSE_MODEL = 21,

  // Logs the status code of the response.
  ONYX_CLI_API_RESPONSE_STATUS_CODE = 22,

  // Logs the duration of the API call in milliseconds.
  ONYX_CLI_API_RESPONSE_DURATION_MS = 23,

  // Logs the input token count of the API call.
  ONYX_CLI_API_RESPONSE_INPUT_TOKEN_COUNT = 25,

  // Logs the output token count of the API call.
  ONYX_CLI_API_RESPONSE_OUTPUT_TOKEN_COUNT = 26,

  // Logs the cached token count of the API call.
  ONYX_CLI_API_RESPONSE_CACHED_TOKEN_COUNT = 27,

  // Logs the thinking token count of the API call.
  ONYX_CLI_API_RESPONSE_THINKING_TOKEN_COUNT = 28,

  // Logs the tool use token count of the API call.
  ONYX_CLI_API_RESPONSE_TOOL_TOKEN_COUNT = 29,

  // Logs the token count for system instructions.
  ONYX_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_SYSTEM_INSTRUCTIONS = 167,

  // Logs the token count for tool definitions.
  ONYX_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_TOOL_DEFINITIONS = 168,

  // Logs the token count for conversation history.
  ONYX_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_HISTORY = 169,

  // Logs the token count for tool calls (JSON map of tool name to tokens).
  ONYX_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_TOOL_CALLS = 170,

  // Logs the token count from MCP servers (tool definitions + tool inputs/outputs).
  ONYX_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_MCP_SERVERS = 171,
  ...
  // Logs the model id of the API call.
  ONYX_CLI_API_ERROR_MODEL = 30,

  // Logs the error type.
  ONYX_CLI_API_ERROR_TYPE = 31,

  // Logs the status code of the error response.
  ONYX_CLI_API_ERROR_STATUS_CODE = 32,

  // Logs the duration of the API call in milliseconds.
  ONYX_CLI_API_ERROR_DURATION_MS = 33,
  ...
  ONYX_CLI_LOOP_DETECTED_TYPE = 38,
  ...
  ONYX_CLI_SLASH_COMMAND_NAME = 41,

  // Logs the subcommand of the slash command.
  ONYX_CLI_SLASH_COMMAND_SUBCOMMAND = 42,

  // Logs the status of the slash command (e.g. 'success', 'error')
  ONYX_CLI_SLASH_COMMAND_STATUS = 51,
  ...
  ONYX_CLI_RESPONSE_FINISH_REASON = 43,

  // Logs the result of the next speaker check
  ONYX_CLI_NEXT_SPEAKER_CHECK_RESULT = 44,
  ...
  ONYX_CLI_MALFORMED_JSON_RESPONSE_MODEL = 45,
  ...
  // Do not use.
  DEPRECATED_ONYX_CLI_KITTY_TRUNCATED_SEQUENCE = 52,

  // Logs the length of the kitty sequence that overflowed.
  ONYX_CLI_KITTY_SEQUENCE_LENGTH = 53,
  ...
  ONYX_CLI_EXTENSION_NAME = 85,

  // Logs the name of the extension.
  ONYX_CLI_EXTENSION_ID = 121,

  // Logs the version of the extension.
  ONYX_CLI_EXTENSION_VERSION = 86,

  // Logs the previous version of the extension.
  ONYX_CLI_EXTENSION_PREVIOUS_VERSION = 117,

  // Logs the source of the extension.
  ONYX_CLI_EXTENSION_SOURCE = 87,

  // Logs the status of the extension install.
  ONYX_CLI_EXTENSION_INSTALL_STATUS = 88,

  // Logs the status of the extension uninstall
  ONYX_CLI_EXTENSION_UNINSTALL_STATUS = 96,

  // Logs the status of the extension uninstall
  ONYX_CLI_EXTENSION_UPDATE_STATUS = 118,

  // Logs the count of extensions in Start Session Event
  ONYX_CLI_START_SESSION_EXTENSIONS_COUNT = 119,

  // Logs the name of extensions as a comma-separated string
  ONYX_CLI_START_SESSION_EXTENSION_IDS = 120,

  // Logs whether the session is running in a Git worktree.
  ONYX_CLI_START_SESSION_WORKTREE_ACTIVE = 191,

  // Logs the setting scope for an extension enablement.
  ONYX_CLI_EXTENSION_ENABLE_SETTING_SCOPE = 102,

  // Logs the setting scope for an extension disablement.
  ONYX_CLI_EXTENSION_DISABLE_SETTING_SCOPE = 107,
  ...
  ONYX_CLI_TOOL_OUTPUT_TRUNCATED_ORIGINAL_LENGTH = 89,

  // Logs the truncated length of the tool output.
  ONYX_CLI_TOOL_OUTPUT_TRUNCATED_TRUNCATED_LENGTH = 90,

  // Logs the threshold at which the tool output was truncated.
  ONYX_CLI_TOOL_OUTPUT_TRUNCATED_THRESHOLD = 91,

  // Logs the number of lines the tool output was truncated to.
  ONYX_CLI_TOOL_OUTPUT_TRUNCATED_LINES = 92,
  ...
  ONYX_CLI_LLM_LOOP_CHECK_FLASH_CONFIDENCE = 126,

  // Logs the name of the main model used for the secondary loop check.
  ONYX_CLI_LLM_LOOP_CHECK_MAIN_MODEL = 127,

  // Logs the confidence score from the main model loop check.
  ONYX_CLI_LLM_LOOP_CHECK_MAIN_MODEL_CONFIDENCE = 128,

  // Logs the model that confirmed the loop.
  ONYX_CLI_LOOP_DETECTED_CONFIRMED_BY_MODEL = 129,
  ...
  ONYX_CLI_ACTIVE_APPROVAL_MODE = 141,

  // Logs the new approval mode.
  ONYX_CLI_APPROVAL_MODE_TO = 142,

  // Logs the duration spent in an approval mode in milliseconds.
  ONYX_CLI_APPROVAL_MODE_DURATION_MS = 143,
  ...
  ONYX_CLI_NETWORK_RETRY_ATTEMPT_NUMBER = 180,

  // Logs the delay in milliseconds for a network retry.
  ONYX_CLI_NETWORK_RETRY_DELAY_MS = 181,

  // Logs the error type for a network retry.
  ONYX_CLI_NETWORK_RETRY_ERROR_TYPE = 182,
