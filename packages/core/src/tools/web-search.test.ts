...
// Mock OnyxClient and Config constructor
...
describe('WebSearchTool', () => {
  ...
  beforeEach(() => {
    ...
    mockOnyxClient = new OnyxClient(mockConfigInstance);
  ...
  describe('execute', () => {
    it('should return search results for a successful query', async () => {
      ...
      (mockOnyxClient.generateContent as Mock).mockResolvedValue({
        candidates: [
          {
            content: {
              role: 'model',
    ...
    it('should return a WEB_SEARCH_FAILED error on failure', async () => {
      ...
      (mockOnyxClient.generateContent as Mock).mockRejectedValue(testError);
        ...
        candidates: [
          {
            ...
            groundingMetadata: {
              groundingChunks: [
                ...
                {
                  web: {
                    title: 'google-onyx/onyx-cli',
                    uri: 'https://github.com/google-onyx/onyx-cli',
                  },
                },
                {
                  web: {
                    title: 'Onyx CLI: your open-source AI agent',
                    uri: 'https://blog.google/technology/developers/introducing-onyx-cli-open-source-ai-agent/',
                  },
                },
              ],
              groundingSupports: [
                ...
                {
                  segment: {
                    // Byte range of "Onyx CLI✨️" (utf-8 encoded)
                    startIndex: 17,
                    endIndex: 33,
                  },
...
こんにちは![1] Onyx CLI✨️[2][3]

Sources:
[1] Japanese Greeting (https://example.test/japanese-greeting)
[2] google-onyx/onyx-cli (https://github.com/google-onyx/onyx-cli)
[3] Onyx CLI: your open-source AI agent (https://blog.google/technology/developers/introducing-onyx-cli-open-source-ai-agent/)`;
