...
describe('summarizers', () => {
  ...
  beforeEach(() => {
    ...
    (mockOnyxClient.generateContent as Mock) = vi.fn();
  ...
  describe('summarizeToolOutput', () => {
    it('should return original text if it is shorter than maxLength', async () => {
      ...
      expect(mockOnyxClient.generateContent).not.toHaveBeenCalled();
    });
    ...
    it('should call generateContent if text is longer than maxLength', async () => {
      ...
      expect(mockOnyxClient.generateContent).toHaveBeenCalledTimes(1);
    ...
    it('should return original text if generateContent throws an error', async () => {
      ...
      (mockOnyxClient.generateContent as Mock).mockRejectedValue(error);
...
`;
      const calledWith = (mockOnyxClient.generateContent as Mock).mock
        .calls[0];
