...
export interface RoutingDecision {
  /** The model identifier string to use for the next API call (e.g., 'onyx-2.5-pro'). */
  model: string;
  /**
...
export interface RoutingStrategy {
   ...
   * @param client A reference to the OnyxClient, allowing the strategy to make its own API calls if needed.
